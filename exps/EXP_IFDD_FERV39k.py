...
class Exp(mainExp):
    def __init__(self):
        ...
        self.use_lowFreq = False # enable by config: Not Used,Deprecated
        self.WaveNorm = False
        ...
        self.dataset_dir = 'datasets/FERV39k'
    ...
    def get_model(self) -> Module:
        ...
        if self.embed_net == 'CNN':
            ...
            embed = embedNet_light(input_channel=3,input_time=16,embed_dim=96,out_resolution=56,facial_project=self.facial_project)
        else:
            raise NotImplementedError()
        backbone = MFViT_FPN(type='MFViT_XS',
    ...
    def get_data_loader(self, mode:str, is_distributed: bool):
        ...
        from core.datasets import FERV39k_CLS
        
        local_rank = get_local_rank()
        with wait_for_the_master(local_rank):
            dataset = FERV39k_CLS(root_dir=self.dataset_dir,
                        mode=mode,
